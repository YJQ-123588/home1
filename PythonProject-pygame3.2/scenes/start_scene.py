...
class StartScene:
    ...
    def __init__(self):
        ...
        self.btn_start = pygame.Rect(SCREEN_WIDTH // 2 - 100, 320, 200, 50)
        self.btn_continue = pygame.Rect(SCREEN_WIDTH // 2 - 100, 320, 200, 50)
        self.btn_save = pygame.Rect(SCREEN_WIDTH // 2 - 100, 390, 200, 50)
        self.btn_load = pygame.Rect(SCREEN_WIDTH // 2 - 100, 390, 200, 50)
        self.btn_help = pygame.Rect(SCREEN_WIDTH // 2 - 100, 460, 200, 50)
        self.btn_quit = pygame.Rect(SCREEN_WIDTH // 2 - 100, 530, 200, 50)
        self.btn_back = pygame.Rect(SCREEN_WIDTH // 2 - 100, 520, 200, 50)
    ...
    def draw(self, screen):
        ...
        if self.can_continue:
            ...
            # 存档
            pygame.draw.rect(screen, (50, 100, 150), self.btn_save)
            pygame.draw.rect(screen, WHITE, self.btn_save, 2)
            btn_text = self.small_font.render("存档", True, WHITE)
            screen.blit(btn_text, (self.btn_save.centerx - btn_text.get_width() // 2,
                                   self.btn_save.centery - btn_text.get_height() // 2))
            ...
            # 读取存档
            pygame.draw.rect(screen, (50, 100, 150), self.btn_load)
            pygame.draw.rect(screen, WHITE, self.btn_load, 2)
            btn_text = self.small_font.render("读取存档", True, WHITE)
            screen.blit(btn_text, (self.btn_load.centerx - btn_text.get_width() // 2,
                                   self.btn_load.centery - btn_text.get_height() // 2))
    ...
    def _draw_load(self, screen):
        ...
        hint = self.help_font.render("按数字键1/2/3快速读取 | 点击「删档」后按Y确认", True, (180, 180, 180))
        hint_x = SCREEN_WIDTH // 2 - hint.get_width() // 2
        screen.blit(hint, (hint_x, 110))
