...
class Elder(NPC):
    ...
    def talk(self, player_hp=None, player_max_hp=None, ultimate_unlocked=False):
        ...
        if self.elder_id == 1:
            ...
            elif not ultimate_unlocked:
                return "长老：大圣，你还没学会「七十二变」呢。\n去找长老2学艺吧！"
            else:
...
class Cattle(NPC):
    ...
    def __init__(self, img_path, x, y, name="牛妖", is_boss=False):
        ...
        self.name = name
        self.max_hp = 250 if is_boss else 100
        self.hp = self.max_hp
