import pygame
from pygame.locals import K_UP, K_DOWN, K_LEFT, K_RIGHT, K_LSHIFT, K_RSHIFT
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.KEYDOWN:
            if event.key in (K_LSHIFT, K_RSHIFT):
                ...
                # 更新当前移动方向的速度
                if self.dx > 0: self.dx = speed
                elif self.dx < 0: self.dx = -speed
                if self.dy > 0: self.dy = speed
                elif self.dy < 0: self.dy = -speed
                return
